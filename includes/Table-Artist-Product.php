...
class TableArtistProduct {
  ...
  public function __construct() {
    global $wpdb;
    $wpdb->query("CREATE TABLE IF NOT EXISTS {$wpdb->prefix}artistProducts (id INT(255) AUTO_INCREMENT PRIMARY KEY, artist_name varchar(40) NOT NULL, artist_id INT(255) NOT NULL, product_name varchar(50) NOT NULL,product_id INT(255) NOT NULL, variation_id INT(255) NOT NULL)");
